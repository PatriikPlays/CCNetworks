...
import one.patriik.ccnetworks.render.NetworkInterfaceNodeBlockEntityRenderer;
...
public class CCNetworksClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockEntityRenderers.register(Registration.ModBlockEntities.NETWORK_INTERFACE_NODE, NetworkInterfaceNodeBlockEntityRenderer::new);
    }
}
